...
class MCIL345GN(MCIL345):
    def __init__(self, data, distributor=None, compression='bz2', columns=COLUMNS, version=0):
        ...
        """
        super(MCIL345GN, self).__init__(data, distributor=distributor, compression=compression, version=version)
        self.prefix = 'MCIL345GN'
    ...
    def writer(self):
        """
        MCIL345GN contains hourly generation curves
