...
class MCIL345GNQH(MCIL345QH):
    def __init__(self, data, distributor=None, compression='bz2', columns=COLUMNS, version=0):
        ...
        """
        super(MCIL345GNQH, self).__init__(data, distributor=distributor, compression=compression, version=version)
        self.prefix = 'MCIL345GNQH'

    def reader(self, filepath):
        """Overrided to keep unbalanced energies"""
    ...
    def writer(self):
        """
        MCIL345GNQH contains hourly generation curves
